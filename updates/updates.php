...
class EDD_CCAvenue_License_Updates {

	const SECRET_KEY = '5b2e2491cc5129.56732842';
	const SERVER_URL = 'https://wpgateways.com';
	const LONG_NAME = 'EDD CCAvenue Gateway';
	const SHORT_NAME = 'EDD CCAvenue';
	const VAR_IDS = '5164,5165,5166,18304';
	const PLUGIN_SLUG = 'edd-ccavenue-gateway';
	const PLUGIN_FILE = 'gateway.php';

	private static $_instance = null;

	public static function get_instance() {
		if ( self::$_instance == null ) {
			self::$_instance = new EDD_CCAvenue_License_Updates();
		}
	...
	public function check_version_update( $checked_data ) {
		...
		if( is_wp_error( $response ) || $response->result == 'error' ) {
			return $checked_data;
		}
...
EDD_CCAvenue_License_Updates::get_instance();